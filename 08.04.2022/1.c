...
int main()
{
    ...
    do
    {
        ...
        case 5:
            ...
            // start = clock();
            insertionSort(arr, n);
            step_count[0] = (INNER_LOOP ? INNER_LOOP : OUTER_LOOP);
            // end = clock();
        ...
        case 6:
            ...
            // start = clock();
            insertionSort(arr, n);
            step_count[1] = (INNER_LOOP ? INNER_LOOP : OUTER_LOOP);
            // end = clock();
        ...
        case 7:
            ...
            insertionSortDesc(arr, n);
            insertionSort(arr, n);
            step_count[2] = (INNER_LOOP ? INNER_LOOP : OUTER_LOOP);
            // end = clock();
        ...
        case 8:
            ...
            printf("----------------------------------------------------\n");
            printf("%d\t %d\t %d\t %d\n", n, step_count[1], step_count[2], step_count[0]);
            return 0;
        }
